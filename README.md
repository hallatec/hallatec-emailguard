...
Live SPF, DKIM, DMARC, BIMI and MX audit for any domain

**Live:** [emailguard.hallatec.com](https://emailguard.hallatec.com/) · **Suite:** [Hallatec Forge](https://forge.hallatec.com/)
...
```bash
wrangler pages deploy . --project-name hallatec-emailguard --branch=main
```
...
to this repository and to emailguard.hallatec.com. See [PROVENANCE.md](PROVENANCE.md) for how to
...
| [H-Score](https://github.com/hallatec/hallatec-hscore) | `hscore.hallatec.com` | Security posture score across the six NIST CSF functions |
