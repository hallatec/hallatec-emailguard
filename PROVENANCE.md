...
This repository is the source of record for **EmailGuard**, one of the nine tools in
...
|---|---|
| Tool | EmailGuard |
| Canonical deployment | https://emailguard.hallatec.com/ |
| Source of record | https://github.com/hallatec/hallatec-emailguard |
...
A genuine deployment returns `repository: "https://github.com/hallatec/hallatec-emailguard"` and
`canonical: "https://emailguard.hallatec.com/"`. `Object.freeze` means a fork cannot quietly mutate
...
**4. Bidirectional link.** This repository names `https://emailguard.hallatec.com/` as its canonical
deployment, and that deployment names `https://github.com/hallatec/hallatec-emailguard` as its source. Either direction
...
curl -s https://emailguard.hallatec.com/ | grep -A2 'code-repository'

# 2. The runtime object agrees (browser console)
#    HTC.provenance.repository === "https://github.com/hallatec/hallatec-emailguard"

# 3. The canonical link points back at the tool's own subdomain
curl -s https://emailguard.hallatec.com/ | grep 'rel="canonical"'
```
